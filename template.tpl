...

{
  ...
  "description": "Attribute GA4 Item List and Promotion data to revenue \u0026 ecommerce Events. This Template makes this possible by using ex. Local Storag as a \"helper\". Last \u0026 First Click Attribution supported.",
  "categories": [
  "ANALYTICS",
  "UTILITY",
  "TAG_MANAGEMENT"
...
Created on 1/7/2023, 9:31:18 PM
